...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String strUrl = "http://api.openweathermap.org/data/2.5/weather?q=" + str + "&units=matric&appid=867d2553fb743f162631454d6ebde974&lang=kr";
